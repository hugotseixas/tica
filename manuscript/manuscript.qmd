...
1. Develop an overview about the ICLF experiments characteristics being conducted in Brazil;   

    1.1. What is the productivity of each component of ICLF systems of different characteristics?
    
    1.2. What are the effects of ICLF systems over soils characteristcs?
    
    1.3. What are the management characteristics of ICLF systems?
    
    1.4. What is the economical revenue of ICLF systems?
    
    1.5. What is the pottential expansion of ICLF systems in Brazil?

2. Estimate the potential of ICLF systems to remove carbon from the atmosphere by 2030 and 2050;
    ...
    2.3. What is the pottential of the expansion of ICLF systems in the emissions reduction pledges made by Brazil?

3.  Evaluate the feasibility of the implementation of ICLF as a mean to reduce emissions, in relation to different perspectives of solutions to avoid climatic catastrophe;

    3.1. Does the expansionof ICLF systems taking into account equity and possible social impacts, as a public policy?
