...
grViz(
  ...
  graph [layout = dot, rankdir = TD, nodesep = 1, ranksep = 0.13]
...
### Reflection about the role of integrated crop-livestock-forest systems in the agrarian question

ICLF and the agrarian question, a directed reading towards the construction of a narrative reflection. Environmental (e.g. climate change and biodiversity) and social (e.g. social inequality, food insecurity) contexts.
