...
The choice of models will depend on a series of tests, accounting the accuracy and adequacy of the model to the theory. 
...
The data will be stored in a nested directories structured database with hive-style partitioning. 
...
The main objective of the project is to delve deeper into the reasons behind vegetation removals and assess their impact on the environment and human well-being. 
This effort has the potential to provide valuable insights into what can reduce the negative consequences after vegetation removal. 
